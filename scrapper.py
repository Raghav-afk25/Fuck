...
async def download_song_from_video_id(video_id: str) -> str:
    ...
    async with semaphore:
        ...
        ydl_opts = {
            ...
            "external_downloader_args": ["-x", "8", "-k", "512K"],  # ❗️Safer chunking
            "concurrent_fragment_downloads": 5,  # ⚠️ Lower to prevent overload
            "retries": 5,
            "fragment_retries": 10,
            "continuedl": True,
            "overwrites": True,
            "noprogress": True,
            "http_chunk_size": "512K",  # ⚠️ Smaller to avoid bans
